...
public class Table
{
   ...
   *   then the return value is a reference to the existing object. Otherwise, 
   *   the new </CODE>element</CODE> is added with the specified <CODE>key</CODE>
   ...
   **/
   public Object put(Object key, Object element)
   {
      ...
      {  // The key is already in the table.
    	 // We will NOT overwrite that value
         answer = data[index];
      }
      ...
      {  // The key is not yet in this Table.
         ...
         if(probe) {
        	 System.out.println("Found open location at index " + index);
         }
         keys[index] = key;
         data[index] = element;
   ...
   **/
   ...
   /**
    * Returns the number of collisions occurred
    */
